  ...
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="项目简称" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productInfo.subName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="项目编号" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productInfo.proNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column label="项目优先级" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productInfo.lccName }}</span>
        </template>
      </el-table-column>
      <el-table-column label="研发模式" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productMode.name }}</span>
        </template>
      </el-table-column>
      <el-table-column label="项目经理" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productPm.userName }}-{{ scope.row.productPm.workNumber }}</span>
        </template>
      </el-table-column>
      <el-table-column label="当前阶段" align="center">
        <template slot-scope="scope">
          <el-tag :type="scope.row.productStage.name">{{ scope.row.productStage.name }}</el-tag>
        </template>
      </el-table-column>
      <el-table-column label="投资额度(万)" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productInfo.invest/10000 }}</span>
        </template>
      </el-table-column>
      <el-table-column label="首年净利润(万)" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productInfo.netProfit/10000 }}</span>
        </template>
      </el-table-column>
      <el-table-column label="激励预算(万)" align="center">
        <template slot-scope="scope">
          <span>{{ scope.row.productInfo.incentiveBudget/10000 }}</span>
        </template>
      </el-table-column>
